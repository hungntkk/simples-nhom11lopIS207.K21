				...
				<div class="row">
					<div class="col-lg-8 col-12">
						<div class="blog-single-main">
							<div class="row">
								<div class="col-12">
									@foreach($show_blog_2 as $key => $blo)
									<div class="image">
										<img src="{{URL::to('/uploads/blog/'.$blo->blog_image)}}" alt="#">
									</div>
									<div class="blog-detail">
										<h2 class="blog-title">{{($blo->blog_name)}}</h2>
										<div class="content">
											<p>{{($blo->blog_content1)}}</p>
											<blockquote> <i class="fa fa-quote-left"></i> {{($blo->blog_quote)}}</blockquote>
											<p>{{($blo->blog_content2)}}</p>
											<p>{{($blo->blog_content3)}}</p>
										</div>
										<div class="blog-meta">
