										...
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li><a href="#">Blog<i {{-- class="ti-angle-down" --}}></i></a>
														{{-- <ul class="dropdown">
															<li><a href="/blog-single-sidebar">Blog Single Sidebar</a></li>
														</ul> --}}
													</li>
							...
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									@foreach($category as $key => $cate)
										...
										<li class="nav-item"><a class="nav-link" data-toggle="tab" href="{{URL::to('/danh-muc'.$cate->id)}}" role="tab">{{($cate->category_name)}}</a></li>
													...
													<form action="{{URL::to('/them-cart')}}" method="POST">
														...
														<div class="button-head">
															...
															<div class="product-action">
																<a data-toggle="modal" data-target="#exampleModal" title="Xem chi tiết" href="{{URL::to('/chi-tiet-san-pham/'.$product->product_id)}}"><i class=" ti-eye"></i><span>Xem chi tiết</span></a>
